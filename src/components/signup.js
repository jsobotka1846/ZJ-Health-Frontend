                ...
                <div className="card-body p-5 text-center">
                    ...
                    <div className="form-outline form-white mb-4">
                      ...
                      <div className="col-md-3 form-outline form-white mb-4">
                        <input type="number" name="zip" className="form-control"  required/>
                      ...
                      <div className="form-outline form-white mb-4">
                        <input type="text" name="insuranceName" className="form-control" required/>
                        <label className="form-label">Insurance Name</label>
                      </div>

                      <div className="form-outline form-white mb-4">
                        <input type="text" name="type" className="form-control"  required/>
                        <label className="form-label">Insurance Type</label>
                      </div>

                      <div className="form-outline form-white mb-4">
                        <input type="text" name="policyNum" className="form-control"  required/>
                  ...
                  <div>
                    <p className="mb-0">Already have an account? <a href="login.html" className="text-white-50 fw-bold">Login</a></p>
                  </div>
